...
<html>
    ...
    <div id="xixi">
        <a href="#create-admLab" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        <div class="nav" role="navigation">
            <ul>
                <li><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="create-admLab" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.admLab}" method="POST">
                <fieldset class="form">
                    <f:all bean="admLab"/>
                </fieldset>
